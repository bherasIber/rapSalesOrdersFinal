CLASS zcl_insert_data_pro_fin_hera DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_insert_data_pro_fin_hera IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.

*/  Declaración de variables
    DATA:
      ls_header TYPE ztheader_heras,
      ls_items  TYPE  zitems_heras,
      lt_header TYPE TABLE OF ztheader_heras,
      lt_items  TYPE TABLE OF zitems_heras.
...
*/  Borramos datos previsos
    ...
    INSERT ztheader_heras FROM TABLE @lt_header.
    ...
    INSERT zitems_heras FROM TABLE @lt_items.
